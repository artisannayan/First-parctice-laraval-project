...
@section('adminpagecontent')
   <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit New District</h1>
             ...
             <div class="col-md-12">
              <div class="card shadow mb-4">
                <div class="card-hear py-3">
                   <h6 class="m-0 font-weight-bold text-primary">Edit The District With Informetion</h6> 
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      <input type="submit" name="editbrand" value="update Distirct" class="btn btn-primary btn-block"> 
                    </div>
                  </form>
