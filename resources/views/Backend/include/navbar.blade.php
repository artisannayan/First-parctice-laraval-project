    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Pages All Category Menu -->
      <li class="nav-item">
      ...
      <!-- Nav Item - Pages All Product Manage Menu -->
      <li class="nav-item">
        ...
        <div id="product" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('manageproduct')}}">Manage All Product</a>
          </div>
        </div>
      </li>
...
<!-- Nav Item - Pages All Brands Manage Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#brand" aria-expanded="true" aria-controls="brand">
          <i class="fas fa-fw fa-cog"></i>
          <span>Brands</span>
        </a>
        <div id="brand" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">All Product</h6>
            <a class="collapse-item" href="{{route('admin.brand.create')}}">Add New Brands</a>
