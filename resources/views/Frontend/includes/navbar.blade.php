          ...
          <div class="top-left pull-left">
            <div class="language">
              <form action="#" method="post" enctype="multipart/form-data" id="language">
                <div class="btn-group">
                  <button class="btn btn-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="{{asset('image/flags/gb.png')}}" alt="English" title="English">English <i class="fa fa-caret-down"></i></button>
    ...
    <div class="header-inner">
      ...
      <div class="col-sm-4 col-xs-12 header-middle">
        <div class="header-middle-top">
          <div id="logo"> <a href="{{route('index')}}"><img src="{{asset('image/banner-img/logoemrc.png')}}" title="E-Commerce" alt="E-Commerce" class="img-responsive" /></a> </div>
        </div>
      </div>
