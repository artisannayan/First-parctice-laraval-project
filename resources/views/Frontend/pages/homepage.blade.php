...
<div class="container">
  ...
  <div id="main-banner" class="owl-carousel home-slider">
    <div class="item"> <a href="#"><img src="{{asset('image/banner-img/banner1.jpg')}}" alt="main-banner1" class="img-responsive" /></a> </div>
    <div class="item"> <a href="#"><img src="{{asset('image/banner-img/banner2.jpg')}}" alt="main-banner2" class="img-responsive" /></a> </div>
    <div class="item"> <a href="#"><img src="{{asset('image/banner-img/banner3.png')}}" alt="main-banner3" class="img-responsive" /></a> </div>
  </div>
</div>
</div>
<div class="container">
                  ...
                  <div class="image product-imageblock"> 
                     ...
                     <a href="{{route('products.show',$product->slug)}}">
                        ...
                        @if($i > 0)
                         ...
                         <img src="{{asset('image/product-image/'.$image->image)}}"alt="{{$product->title}}" title="{{$product->title}}" class="img-responsive" style="height: 250px; width: 350px;"  />
                        @endif
                        @php $i--; @endphp
                        @endforeach
                    </a>
